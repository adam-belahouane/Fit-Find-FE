...
const NewReviewModal = ({ show, setShow, value, setValue, review, setReview }) => {
    ...
    <div className="modal" onClick={() => setShow(false)}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <textarea name="maincontent" id="mainreviewcontent"
        ...
        {isloggedin === true && role === 'normal' ?<button className="button" onClick={() => newReview()}>
            Submit
          </button>: <button className="button" onClick={() => handleRedirect()}>
            Login
          </button>}
